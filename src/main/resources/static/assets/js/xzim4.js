var xiaozhuIMBootstrap= {
    ...
    webIMInit: function() {
        ...
        if (this.userInfoCookie && loginUserId) {
            this.setQRCodeText(true);
            this.loginWebIMInit();
        } else {
            this.setQRCodeText(false);
    ...
    switchShowQrCodeFun: function(){
      ...
      // FangDong_
      if(!opVar) return;
      if(opVar.indexOf('FangDong')>-1 ||opVar.indexOf('FangKe')>-1  || opVar.indexOf('FD')>-1  ){
        document.getElementById('im_nologin_qr').style.display= "block";
      }
    },
